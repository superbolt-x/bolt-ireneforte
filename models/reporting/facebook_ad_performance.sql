...
CASE WHEN ad_name = 'Static - Age-Defying Secret Ingredient - Serums & Oils PLP - Hero Product Approach - NonLifestyle - Face Serum' AND region = 'US' THEN 'https://fb.me/2gA3bFCbmp9SznF'
    ...
    WHEN ad_name = 'Static - New Beauty Best Night Cream - Moisturizers PLP - Press Award Approach - NonLifestyle - Face Cream - Product Tag' AND region = 'US' THEN 'https://fb.me/1RSQHIYwxkD2HNk'
    WHEN ad_name = 'Static - Clarify And Refine Elle Green Beauty Stars - Masks & Scrubs PLP - Press Award Approach - NonLifestyle - Face Scrub - Product Tag' AND region = 'US' THEN 'https://fb.me/aLJ9fO1yzlSZ8W'
    WHEN ad_name = 'Static - Organic Ingredients Clinically Proven Results Ferri & Irene - Face PLP - Brand Intro Approach - Lifestyle - Face - Copy' AND region = 'US' THEN 'https://fb.me/21wsmWy12Z3uOJM'
    WHEN ad_name = 'Video - Meet The Gamechanger Phyto - Phyto PDP - Lifestyle - Face - Phytomelatonin Launch - Phytomelatonin - Copy' AND region = 'US' THEN 'https://fb.me/1GKwFXXlnxsiVT9'
    WHEN ad_name = 'Carousel - Forte Illuminante Routine - Multiple PLP - Routines Approach - Conversion Focused Instant Experience - NonLifestyle - Face - 20% off iteration' AND region = 'US' THEN 'https://fb.me/bjlMM36UeOvTJu'
